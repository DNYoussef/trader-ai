...
MODULE_PATH = 'components.utilities.circuit_breaker.circuit_breaker'
EXPORTS = ['CircuitBreaker', 'CircuitBreakerConfig', 'CircuitBreakerError', 'CircuitBreakerManager', 'CircuitBreakerMetrics', 'CircuitBreakerStatus', 'CircuitState']
