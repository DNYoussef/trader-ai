...
MODULE_PATH = 'components.observability.tagging_protocol'
EXPORTS = ['AgentCategory', 'INTENT_DESCRIPTIONS', 'Intent', 'TaggingProtocol', 'create_simple_tagger', 'create_tagger']
