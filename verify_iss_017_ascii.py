...
def test_calibration_engine():
    ...
    try:
        ...
        print("   [PASS] PASS: Real Brier score calculation")
        ...
        print("   [PASS] PASS: Real Kelly fraction calculation")
        ...
        print("   [PASS] PASS: Real CRRA utility with loss aversion")
        ...
        print("   [PASS] PASS: Real PIT test calculation")

        print("\n[PASS] AI CALIBRATION ENGINE: ALL TESTS PASSED")
        return True
...
def test_signal_generator():
    ...
    try:
        ...
        print("   [PASS] PASS: Real DPI calculation")
        ...
        print("   [PASS] PASS: Real narrative gap calculation")
        ...
        print("   [PASS] PASS: Real catalyst timing calculation")

        print("\n[PASS] AI SIGNAL GENERATOR: ALL TESTS PASSED")
        return True
...
def test_mispricing_detector():
    ...
    try:
        ...
        print("   [PASS] PASS: Real EVT-based risk calculation")
        ...
        print("   [PASS] PASS: Real safety score with asset-specific risk")
        ...
        print("   [PASS] PASS: Real inequality-adjusted returns")

        print("\n[PASS] AI MISPRICING DETECTOR: ALL TESTS PASSED")
        return True
...
def test_compliance_engine():
    ...
    try:
        ...
        print("   [PASS] PASS: Engine initialized successfully")
        ...
        print("   [PASS] PASS: Path security validation functional")
        ...
        print("   [PASS] PASS: Cryptographic scanning functional")

        print("\n[PASS] DFARS COMPLIANCE ENGINE: ALL TESTS PASSED")
